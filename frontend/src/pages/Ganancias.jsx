          ...
          <div className="space-y-3">
              ...
              {historyList.map((item, i) => {
                ...
                return (
                  <motion.div
                    ...
                    className="group"
                  >
                    <Card variant="flat" className="p-4 flex items-center gap-4 transition-all hover:border-white/10 active:scale-[0.98]">
                      <div className={cn(
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-2 mt-0.5">
                          <Clock size={10} className="text-sav-muted" />
                          <p className="text-[9px] font-bold text-sav-muted uppercase tracking-wider">
                      ...
                      <div className="text-right">
                        ...
                        <p className="text-[9px] font-bold text-sav-muted uppercase tracking-tighter">BOB</p>
                      </div>
                    </Card>
                  </motion.div>
                );
            ...
            {historyList.length === 0 && (
              <div className="py-20 flex flex-col items-center justify-center space-y-4">
                <div className="w-16 h-16 bg-sav-surface border border-sav-border rounded-3xl flex items-center justify-center text-sav-muted/30">
                  <History size={32} />
                </div>
                <p className="text-[10px] font-black text-sav-muted uppercase tracking-[0.2em]">Sin movimientos</p>
              </div>
            )}
          </div>
        </section>
