    ...
    <header className={cn(
      ...
      <div className="flex items-center gap-4 min-w-0 flex-1">
        <button
          type="button"
          onClick={handleBack}
          className="group flex items-center justify-center w-10 h-10 rounded-2xl bg-white/5 border border-white/5 text-white active:scale-90 transition-all hover:bg-sav-primary/20 hover:border-sav-primary/30 shadow-lg"
        >
          <ChevronLeft size={22} className="group-hover:-translate-x-0.5 transition-transform" />
        </button>
        
        <div className="flex flex-col min-w-0">
          <h1 className="font-black text-white text-sm uppercase tracking-[0.2em] truncate drop-shadow-sm">
            {title}
          </h1>
