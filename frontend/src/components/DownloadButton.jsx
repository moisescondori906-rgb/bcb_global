          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            {device === 'ios' ? (
              ...
              <a
                href={CONFIG.APK_DOWNLOAD_URL}
                download="app-bcb-global.apk"
                className="w-full md:w-auto px-8 py-3 bg-sav-primary hover:bg-sav-accent text-white rounded-2xl font-black text-[10px] uppercase tracking-[0.2em] transition-all shadow-lg shadow-sav-primary/20 active:scale-95 text-center"
              >
    ...
    <div className="w-full flex flex-col items-center justify-center py-6 px-4">
      ...
      <div className="relative group w-full max-w-[280px]">
        ...
        >
          ...
          <ExternalLink size={18} className="text-white/20 group-hover:text-sav-primary transition-colors" />
        </button>
      ) : (
        <a
          href={CONFIG.APK_DOWNLOAD_URL}
        ...
        >
          <div className="flex items-center gap-4">
            <div className="bg-sav-surface p-2 rounded-xl shadow-lg transition-transform duration-500 group-hover:rotate-12 border border-white/5">
              <DownloadCloud size={24} className="text-sav-primary" strokeWidth={2.5} />
            </div>
            <div className="text-left">
              <p className="text-[10px] font-black text-sav-muted uppercase tracking-widest leading-none mb-1">
                Android App
          ...
          <Smartphone size={18} className="text-white/20 group-hover:text-sav-primary transition-colors" />
        </a>
      )}
      </div>
      {showIosModal && <IosInstructions onClose={() => setShowIosModal(false)} />}
  ...
  <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 bg-sav-dark/95 backdrop-blur-md animate-fade-in">
    <div className="w-full max-w-sm bg-sav-card rounded-[2.5rem] shadow-2xl overflow-hidden border border-white/10 relative">
      ...
      <div className="p-8 pt-12 text-center">
        ...
        <p className="text-[10px] font-bold text-sav-muted uppercase tracking-widest mb-8">
        ...
        <div className="space-y-4 text-left">
          <div className="flex items-center gap-4 p-4 rounded-2xl bg-white/5 border border-white/5 group">
            ...
            <div className="flex-1">
              ...
              <p className="text-[10px] font-medium text-sav-muted">Usa Safari para la mejor experiencia.</p>
            </div>
          </div>
