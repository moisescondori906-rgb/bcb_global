...
const API_VERSION = '11.3.6';

// Endpoint de Healthcheck Profesional v11.3.6 (Resiliente con Timeout)
...
async function startServer() {
  try {
    ...
    const server = app.listen(PORT, '0.0.0.0', () => {
      console.log(`[SERVER] BCB Global Backend v11.3.6 estable en puerto ${PORT}`);
