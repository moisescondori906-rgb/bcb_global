...
const API_VERSION = '11.3.3';

// Endpoint de Healthcheck Profesional v11.3.3 (Resiliente y Real)
...
async function startServer() {
  try {
    ...
    const server = app.listen(PORT, '0.0.0.0', () => {
      console.log(`[SERVER] BCB Global Backend v11.3.3 estable en puerto ${PORT}`);
